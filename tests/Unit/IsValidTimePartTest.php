 ...
 */
function provideValidTimeParts(): array
{
    return [
 ...
 * @return array<string, array{0: array{year?: int, month?: int, day?: int, hour: int, minute: int, second: int}, 1: bool}>
 */
function provideInvalidTimeParts(): array
{
    return [
 ...
 * @return array<string, array{0: array{year?: int, month?: int, day?: int, hour: int, minute: int, second: int}, 1: bool}>
 */
dataset('provideTimeParts', fn(): array => array_merge(
    provideValidTimeParts(),
    provideInvalidTimeParts(),
));
